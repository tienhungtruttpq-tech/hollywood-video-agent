...
VIDEO=ROOT/'output/Hollywood_Then_Now_8min.mp4'
...
times=[.8,14.6,26.0,54.2,74.6,86.1,169.8,179.5,193.0,249.5,294.5,314.5,344.5,374.5,404.5,449.5,462.3,472.,477.]
...
for page in range(3):
 ...
 canvas.save(ROOT/'work'/f'encoded_review_{page+1}.jpg',quality=93)
c.release()
...
(ROOT/'work/audio_loudness.txt').write_text(summary+'\n')
...
(ROOT/'work/validation.json').write_text(json.dumps(result,indent=2));print(json.dumps(result,indent=2));print(summary)
