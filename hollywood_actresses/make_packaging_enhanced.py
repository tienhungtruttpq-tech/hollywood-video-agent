...
def make_thumbnails():
 ...
 a=r.with_flow(gradient_bottom(a,358,.98),1.6);d=ImageDraw.Draw(a)
 ...
 a.save(OUT/'Thumbnail_A_Enhanced.jpg',quality=94,optimize=True)
 ...
 b=r.with_flow(gradient_bottom(b,470,.92),1.6);d=ImageDraw.Draw(b)
 ...
 r.text(d,(1043,145),'3',200,r.CREAM,'display',anchor='mt')
 ...
 b.save(OUT/'Thumbnail_B_Enhanced.jpg',quality=94,optimize=True)
...
def write_credits():
 ...
 '- Fonts: Outfit (bold headlines) and Manrope (body/captions), SIL Open Font License.',
